...
int move_right(t_player *r)
{
    ...
    double old_dir_x = r->dir_x;
    double old_plane_x = r->plane_x;
...
int move_up(t_player *r, t_map *map)
{
    ...
    double move_x = r->dir_x * move_speed;
    double move_y = r->dir_y * move_speed;
...
int strafe_left(t_player *r, t_map *map)
{
    ...
    // For strafing left, rotate the direction vector 90 degrees counter-clockwise
    double move_x = -r->dir_y * move_speed;
    double move_y = r->dir_x * move_speed;
